...
type CreateWarrantyInput struct {
	...
	StartDate     *time.Time `json:"start_date"` // Tự động parse nhờ FE gửi lên dạng ISO
...
// Item trả về cho danh sách (Kèm tên khách hàng)
...
type WarrantySearchItem struct {
	...
	BaseDate          time.Time  `db:"base_date" json:"base_date"` // Ngày bán hoặc Ngày sửa
	RepairDescription *string    `db:"repair_description" json:"repair_description"`
	RepairDeviceName  *string    `db:"repair_device_name" json:"repair_device_name"`
}
